...
Las siguientes OG images están usando un placeholder temporal (copia de og-dancehall.jpg).
...
- ✅ og-dancehall.jpg (existe)
- ✅ og-yunaisy-farray.jpg (existe)
...
**Recuerda**: Después de crear las imágenes, actualiza también `dist/images/`
