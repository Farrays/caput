/**
 * Generic Dance Hero Section
 * Replaces: DancehallHeroSection, HipHopHeroSection, TwerkHeroSection
 * Reduces code duplication by 94% (~420 lines → ~25 lines per usage)
 */
...
interface DanceHeroSectionProps {
  t: (key: string) => string;
...
const DanceHeroSection: React.FC<DanceHeroSectionProps> = ({
  t,
  breadcrumbItems,
  keys,
  sectionId,
...
export default React.memo(DanceHeroSection);
